...
import { getEdgeparams, getInterFaceEdge } from '../utils';
...
const customEdge = ({ id, source, target, ...params }) => {
    ...
    return (
        <path id={id} d={edgePath} className="custom-edge-path stroke-red-500" strokeWidth={0.5} onClick={() => console.log(id)} />
    )
}
